...
python3 surepatch.py --platform=mactest --action=create_project --project=os_path --target=[os] --file=[/Users/admin/macos_packages.txt]
...
python3 surepatch.py --platform=mactest --action=create_project --project=req_path --target=req --file=/Users/admin/requirements.txt

echo "7. create project REQ3 auto system from path /Users/admin/requirements.txt"
python3 surepatch.py --platform=mactest --action=create_project --project=req3_path --target=req3 --file=/Users/admin/requirements.txt
...
python3 surepatch.py --platform=mactest --action=create_project --project=npm_local_none --target=npm_local --file=/Users/admin/workspace/node

echo "10. create project NPM auto system from path package.json"
python3 surepatch.py --platform=mactest --action=create_project --project=npm_package_json --target=package_json --file=/Users/admin/package.json

echo "11. create project NPM auto system path package-lock.json"
python3 surepatch.py --platform=mactest --action=create_project --project=npm_package_lock_json --target=package_lock_json --file=/Users/admin/package-lock.json
...
python3 surepatch.py --platform=mactest --action=create_project --project=gemfile --target=gemfile --file=/Users/admin/Gemfile

echo "14. create project GEMFILE.lock auto system from path /Users/admin/Gemfile.lock"
python3 surepatch.py --platform=mactest --action=create_project --project=gemfile_lock --target=gemfile_lock --file=/Users/admin/Gemfile.lock

echo "15. create project PHP Composer JSON auto system from path /Users/admin/composer1.json"
python3 surepatch.py --platform=mactest --action=create_project --project=php_composer_json --target=php_composer_json --file=/Users/admin/composer1.json

echo "16. create project PHP Composer Lock auto system from path /Users/admin/composer1.lock"
python3 surepatch.py --platform=mactest --action=create_project --project=php_composer_lock --target=php_composer_lock --file=/Users/admin/composer1.lock

echo "17. create project POM auto system from path /Users/admin/pom2.xml"
python3 surepatch.py --platform=mactest --action=create_project --project=pom --target=pom --file=/Users/admin/pom2.xml

echo "18. create project YARN auto system from path /Users/admin/yarn.lock"
python3 surepatch.py --platform=mactest --action=create_project --project=yarn --target=yarn --file=/Users/admin/yarn.lock

echo "19. create project USER auto user from path /Users/admin/user_packages.txt"
python3 surepatch.py --platform=mactest --action=create_project --project=user_path --format=user --file=/Users/admin/user_packages.txt
...
python3 surepatch.py --platform=mactest --action=create_project --project=settest --format=user --file=/Users/admin/user_packages.txt
...
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=os --file=/Users/admin/macos_packages.txt
...
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=req --file=/Users/admin/requirements.txt

echo "27. create project REQ3 auto system from path /Users/admin/requirements.txt"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=req3 --file=/Users/admin/requirements.txt
...
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=npm_local --file=/Users/admin/workspace/node

echo "30. create project NPM auto system from path package.json"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=package_json --file=/Users/admin/package.json

echo "31. create project NPM auto system path package-lock.json"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=package_lock_json --file=/Users/admin/package-lock.json
...
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=gemfile --file=/Users/admin/Gemfile

echo "34. create project GEMFILE.lock auto system from path /Users/admin/Gemfile.lock"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=gemfile_lock --file=/Users/admin/Gemfile.lock

echo "35. create project PHP Composer JSON auto system from path /Users/admin/composer1.json"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=php_composer_json --file=/Users/admin/composer1.json

echo "36. create project PHP Composer Lock auto system from path /Users/admin/composer1.lock"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=php_composer_lock --file=/Users/admin/composer1.lock

echo "37. create project POM auto system from path /Users/admin/pom2.xml"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=pom --file=/Users/admin/pom2.xml

echo "38. create project YARN auto system from path /Users/admin/yarn.lock"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --target=yarn --file=/Users/admin/yarn.lock

echo "39. create project USER auto user from path /Users/admin/user_packages.txt"
python3 surepatch.py --platform=mactest --action=create_set --project=settest --format=user --file=/Users/admin/user_packages.txt
...
python3 surepatch.py --action=create_project --platform=mactest --project=multitest2 --target=[os,pip,pom,gem,gemfile] --file=[no,no,/Users/admin/pom2.xml,no,/Users/admin/Gemfile]

echo "42. create set for YARN, PIP3 and Gemfile.lock"
python3 surepatch.py --action=create_set --platform=mactest --project=settest --target=[yarn,pip3,gemfile_lock] --file=[/Users/admin/yarn.lock,no,/Users/admin/Gemfile.lock]
...
echo "46. show issues"
python3 surepatch.py --action=show_issues --platform=mactest --project=settest --file=/Users/admin/issues_report.txt
