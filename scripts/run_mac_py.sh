...
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_npm_package_lock_path --target=package_lock_json --method=auto --format=system --file=/package-lock.json
