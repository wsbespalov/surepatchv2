...
./surepatch_mac --action=create_project --platform=autotest_mac --project=autotest_pip3_none --target=pip3 --method=auto --format=system
...
./surepatch_mac --action=create_project --platform=autotest_mac --project=autotest_pom_xml --target=pom --method=auto --format=system --file=/pom.xml

echo "22. create project autotest_yarm_lock - yarn.lock file"
./surepatch_mac --action=create_project --platform=autotest_mac --project=autotest_yarm_lock --target=yarn --method=auto --format=system --file=/yarn.lock
...
./surepatch_mac --action=create_set --platform=autotest_mac --project=autotest_set_test --set=pip3_none.1 --target=pip3 --method=auto --format=system
...
./surepatch_mac --action=create_set --platform=autotest_mac --project=autotest_set_test --target=pom --method=auto --format=system --file=/pom.xml

echo "42. create project autotest_yarm_lock - yarn.lock file"
./surepatch_mac --action=create_set --platform=autotest_mac --project=autotest_set_test --target=yarn --method=auto --format=system --file=/yarn.lock
