...
python3 surepatch.py --action=create_platform --platform=autotest_mac --description=NewPlatformForAutotestMacOS

echo "3. create project autotest_os_none - OS packages, collected by shell command"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_os_none --target=os --method=auto --format=system

echo "4. create project autotest_os_path - OS packages, collected from shell command, unloaded to file"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_os_path --target=os --method=auto --format=system --file=/macos_packages.txt
...
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_req_path --target=req --method=auto --format=system --file=/requirements.txt

echo "8. create project autotest_npm_none - NPM packages, collected from shell command (npm list --json) from root dir"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_npm_none --target=npm --method=auto --format=system
...
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_npm_path --target=npm --method=auto --format=system --file=/npm.txt

echo "10. create project autotest_local_none - NPM packages, collected from shell command (npm list --json) from local dir"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_local_none --target=npm_local --method=auto --format=system --file=/

echo "11. create project autotest_npm_package_lock_path - NPM packages, collected from package-lock.json file"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_npm_package_lock_path --target=package_lock_json --method=auto --format=system --file=/package_lock.json

echo "12. create project autotest_npm_package_json - NPM packages, collected from package.json file"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_npm_package_json --target=package_json --method=auto --format=system --file=/package.json

echo "13. create project autotest_gem_none - Ruby packages, collected from shell command"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_gem_none --target=gem --method=auto --format=system

echo "14. create project autotest_gem_path - Ruby packages, collected from shell commend, unloaded to file"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_gem_path --target=gem --method=auto --format=system --file=/gem.list

echo "15. create project autotest_gemfile_path - Ruby packages, collected from Gemfile"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_gemfile_path --target=gemfile --method=auto --format=system --file=/Gemfile

echo "16. create project autotest_gemfile_path - Ruby packages, collected from Gemfile.lock"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_gemfile_lock_path --target=gemfile_lock --method=auto --format=system --file=/Gemfile.lock

echo "17. create project autotest_any_user_path - User packages formatted as name=version"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_any_user_path  --method=auto --format=user --file=/user_packages.txt

echo "18. create project autotest_any_user_none - User packages asked from console"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_any_user_none --method=manual --format=user

echo "19. create project autotest_php_composer_json - PHP Composer file"
python3 surepatch.py --action=create_project --platform=autotest_mac --project=autotest_php_composer_json --target=php_composer_json --method=auto --format=system --file=/composer1.json
...
python3 surepatch.py --action=create_set --platform=autotest_mac --project=autotest_set_test --set=npm_package_json_lock_path.1 --target=package_lock_json --method=auto --format=system --file=/package_lock.json
