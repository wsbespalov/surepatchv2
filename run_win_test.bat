...
c:\Python36\python.exe surepatch.py --action=create_project --platform=autotest1 --project=autotest_php_composer_lock --target=php_composer_lock --method=auto --format=system --file=c:\composer1.lock
timeout 3
...
c:\Python36\python.exe surepatch.py --action=create_set --platform=autotest1 --project=autotest_set_test --set=php_composer_json.1 --target=php_composer_json --method=auto --format=system --file=c:\composer1.json
timeout 3
echo 38. create set autotest_php_composer_lock - PHP Composer.lock file
c:\Python36\python.exe surepatch.py --action=create_set --platform=autotest1 --project=autotest_set_test --set=php_composer_lock.1 --target=php_composer_lock --method=auto --format=system --file=c:\composer1.lock
timeout 3
