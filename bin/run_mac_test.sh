...
./surepatch_mac --action=create_set --platform=autotest_mac --project=autotest_set_test --set=os_path.1 --target=os --method=auto --format=system --file=windows_packages.txt
...
./surepatch_mac --action=create_set --platform=autotest_mac --project=autotest_set_test --set=npm_local_path.1 --target=npm_local --method=auto --format=system --file=workspace\node
